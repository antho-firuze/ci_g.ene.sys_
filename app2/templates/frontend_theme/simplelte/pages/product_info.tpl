...
<script>
	...
	$("#metalwinding").slimScroll({ height: '500px', width: '100%', axis: 'both' });
	$("#fillermaterials").slimScroll({ height: '500px', width: '100%', axis: 'both' });
	$("#torqueinstallation").slimScroll({ height: '500px', width: '100%', axis: 'both' });
	$("#targettorque").slimScroll({ height: '500px', width: '100%', axis: 'both' });
</script>
