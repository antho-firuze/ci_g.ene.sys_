...
class Sales_Model extends CI_Model
{
	...
	{
		$params['select']	= isset($params['select']) ? $params['select'] : "t1.*, coalesce(t1.code,'') ||'_'|| t1.name as code_name, to_char(t1.validfrom, '".$this->session->date_format."') as validfrom, (select coalesce(code,'') ||'_'|| name from m_pricelist where id = t1.pricelist_id limit 1) as pricelist_name ";
