...
class Hrm_db extends CI_Controller {
	...
	*/
	...
	function table_hr_personnel()
	{
		...
		$fields['call_name'] 	= ['type' => 'VARCHAR', 'constraint' => '60', 'null' => TRUE];
		...
		/* Employee area */
		$fields['is_prospective_employee'] 	= ['type' => 'CHAR', 'constraint' => '1', 'default' => '0'];
		...
		/* For Teacher */
		$fields['is_prospective_teacher'] 	= ['type' => 'CHAR', 'constraint' => '1', 'default' => '0'];
		$fields['is_teacher'] 	= ['type' => 'CHAR', 'constraint' => '1', 'default' => '0'];
		/* For Student */
		$fields['is_prospective_student'] 	= ['type' => 'CHAR', 'constraint' => '1', 'default' => '0'];
		$fields['is_student'] 	= ['type' => 'CHAR', 'constraint' => '1', 'default' => '0'];
