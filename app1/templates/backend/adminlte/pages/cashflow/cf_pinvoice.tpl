...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"70px", orderable:false, className:"dt-head-center dt-body-center", data:"payment_plan_date_order", title:"Payment Plan Date (PO)" },
			{ width:"70px", orderable:false, className:"dt-head-center dt-body-center", data:"payment_plan_date", title:"Payment Plan Date (Invoice)" },
			{ width:"100px", orderable:false, data:"doc_no_order", title:"PO Doc No" },
			{ width:"70px", orderable:false, className:"dt-head-center dt-body-center", data:"doc_date_order", title:"PO Doc Date" },
			{ width:"70px", orderable:false, className:"dt-head-center dt-body-center", data:"eta_order", title:"PO ETA" },
			{ width:"100px", orderable:false, data:"note", title:"Payment Note" },
			{ width:"200px", orderable:false, data:"description", title:"Description" },
			{ width:"150px", orderable:false, data:"invoice_type", title:"Invoice Type" },
