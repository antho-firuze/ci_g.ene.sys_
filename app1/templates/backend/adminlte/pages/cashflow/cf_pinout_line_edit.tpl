...
<script>
	...
	col.push(BSHelper.Combobox({ horz:false, label:"PO Line", label_link:"{$.const.PAGE_LNK}?pageid=93", textField:"list_name", idname:"order_line_id", url:"{$.php.base_url('cashflow/cf_porder_line')}?for_material_receipt=1", remote: true, required: false, }));
