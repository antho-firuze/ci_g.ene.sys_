...
<script>
	...
	col.push(BSHelper.Combobox({ horz:false, label:"Branch", label_link:"{$.const.PAGE_LNK}?pageid=18", textField:"name_tree", idname:"branch_id", url:"{$.php.base_url('systems/a_org_parent_list?orgtype_id=3')}", remote: true }));
