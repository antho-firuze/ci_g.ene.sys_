...
<script>
	...
	col.push(BSHelper.Combobox({ label:"Type", idname:"plan_type", required: true, value: 0, disabled: false, 
		list:[
	...
	col.push(BSHelper.Combobox({ horz:false, label:"Payment Note", textField:"note", idname:"order_plan_id", url:"{$.php.base_url('cashflow/cf_porder_plan')}?for_invoice=1&filter=order_id=99", remote: true, required: true }));
