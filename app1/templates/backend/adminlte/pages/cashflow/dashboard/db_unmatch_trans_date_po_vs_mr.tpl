...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"50px", orderable:true, className:"dt-head-center dt-body-center", data:"received_date", title:"Received Date" },
			...
			{ width:"100px", orderable:true, className:"dt-head-center dt-body-right", data:"sub_total", title:"Sub Amount", render: function(data, type, row){ return format_money(data); } },
			{ width:"100px", orderable:true, className:"dt-head-center dt-body-right", data:"vat_total", title:"VAT Amount", render: function(data, type, row){ return format_money(data); } },
			{ width:"100px", orderable:true, className:"dt-head-center dt-body-right", data:"grand_total", title:"Grand Amount", render: function(data, type, row){ return format_money(data); } },
