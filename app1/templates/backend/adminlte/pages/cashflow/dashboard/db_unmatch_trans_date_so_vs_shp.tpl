...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"50px", orderable:true, className:"dt-head-center dt-body-center", data:"delivery_date", title:"Delivery Date" },
			{ width:"50px", orderable:true, className:"dt-head-center dt-body-center", data:"estimation_late", title:"DT to Deadline", },
			{ width:"50px", orderable:true, className:"dt-head-center dt-body-center", data:"late", title:"Late", 
			...
			{ width:"100px", orderable:true, className:"dt-head-center dt-body-right", data:"penalty_amount", title:"Penalty Amount", render: function(data, type, row){ return format_money(data); } },
