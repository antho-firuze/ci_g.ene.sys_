...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"50px", orderable:false, className:"dt-head-center dt-body-center", data:"payment_date", title:"Voucher Date" },
			...
			{ width:"100px", orderable:false, data:"payment_status", title:"Status" },
		],
		order: ['id desc'],
	};
