...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"100px", orderable:true, data:"ar_ap_no", title:"Inflow No" },
			...
			{ width:"100px", orderable:true, className:"dt-head-center dt-body-right", data:"ttl_amt", title:"Received Amount (Plan)", render: function(data, type, row){ return format_money(data); } },
