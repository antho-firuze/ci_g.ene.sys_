...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"100px", orderable:true, className:"dt-head-center dt-body-right", data:"net_amount", title:"SO Taxable (Amount)", render: function(data, type, row){ return format_money(data); } },
		],
	};
