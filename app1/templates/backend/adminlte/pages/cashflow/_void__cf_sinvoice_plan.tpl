...
<script>
	...
	col.push(BSHelper.Input({ horz:true, type:"text", label:"Grand Total", idname:"grand_total", style: "text-align: right;", format: format_money, required: false, value: 0, readonly: true, }));
	col.push(BSHelper.Input({ horz:true, type:"text", label:"Total Plan", idname:"plan_total", style: "text-align: right;", format: format_money, required: false, value: 0, readonly: true, }));
