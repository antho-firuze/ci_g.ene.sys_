...
<script>
	...
	col.push(BSHelper.Input({ horz:true, type:"text", label:"Total Plan", idname:"plan_total", style: "text-align: right;", format: format_money_2, required: false, value: 0, readonly: true, }));
