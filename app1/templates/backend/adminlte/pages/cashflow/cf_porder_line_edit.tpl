...
<script>
	...
	col.push(BSHelper.Combobox({ horz:false, label:"Requisition Line", label_link:"{$.const.PAGE_LNK}?pageid=88", textField:"list_name", idname:"requisition_line_id", url:"{$.php.base_url('cashflow/cf_requisition_line')}?for_purchase_order=1&having=qty", remote: true, required: true, }));
