...
<script>
	...
	col.push(BSHelper.Combobox({ horz:false, label:"MR Line", label_link:"{$.const.PAGE_LNK}?pageid=94", textField:"list_name", idname:"inout_line_id", url:"{$.php.base_url('cashflow/cf_pinout_line')}?for_invoice=1", remote: true, required: false, }));
