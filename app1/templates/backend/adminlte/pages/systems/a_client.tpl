...
<script>
	...
	var aLBtn = [];
	aLBtn.push('<button type="button" title="Copy" name="btn-copy" class="btn btn-xs btn-info glyphicon glyphicon-duplicate" style="margin-right:5px;" />');
	aLBtn.push('<button type="button" title="Edit" name="btn-edit" class="btn btn-xs btn-success glyphicon glyphicon-edit" style="margin-right:5px;" />');
	aLBtn.push('<button type="button" title="Delete" name="btn-delete" class="btn btn-xs btn-danger glyphicon glyphicon-trash" style="margin-right:5px;" />');
	...
	dataTable1 = tableData1.DataTable({ "pagingType": 'full_numbers', "processing": true, "serverSide": true, "select": true, 
		...
		"columns": [
			...
			{ width:"90px", orderable:false, className:"dt-head-center dt-body-center", title:"Actions", render: function(){ return aLBtn.join(""); } },
