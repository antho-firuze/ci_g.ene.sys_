...
<script>
	...
	col.append(BSHelper.Combogrid({ horz:false, label:"Currency", idname:"currency_id", url:"{$.php.base_url('systems/c_currency')}", isLoad:true, placeholder:"typed or choose" }));
