...
<script>
	...
	$("#user_orgtrx_id").shollu_cb({ url:"{$.php.base_url('systems/a_user_org')}?identify=1&filter=user_id=0", idField:"org_id", textField:"code_name", emptyMessage:"<center><b>No results were found</b></center>", remote:true, });
